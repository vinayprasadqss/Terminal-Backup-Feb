  ...
  const showPaidFeatureMessage = () => {
    swal({
      ...
      if (result.isConfirmed) {
        // Handle the logic to navigate to the upgrade page or perform an upgrade action.
        // You can redirect the user to the upgrade page or trigger the necessary actions.
        console.log(
    ...
    <>
      ...
      >
        <div className="listCol list-check rx">
          <Checkbox
            onChange={(e) => handleCheckboxChange(e.target.checked, result)}
            checked={
              portfolioItem?.find((f) => f?.id === result?.bq_organization_id)
                ? true
                : false
            }
          />
