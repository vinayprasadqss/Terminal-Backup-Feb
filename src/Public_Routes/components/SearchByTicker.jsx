...
import Report2 from "../../Report";
import { Switch } from "antd";
import SearchTickerInput from "../../components2/controls/SearchTickerInput";
...
const SearchByTicker = ({ setCountLoading }) => {
              ...
              <div className="searchResults">
                ...
                <div className="silent">
                  {loading ? (
                    ...
                    stateResult?.map((d, i) => (
                      <Hit keys={i + "ticker"} d={d?.fields} showPaidFeatureMessage={showPaidFeatureMessage}
