...
import { Sidebar, checkSession, searchQuery } from "../../Aws/Aws-free-api";
...
const CompanySearchView = ({ query, setQuery, setCountLoading }) => {
  const [display, setDisplay] = useState(0);
  // const [query1, setQuery1] = useState("1010DATA SERVICES, LLC.");
