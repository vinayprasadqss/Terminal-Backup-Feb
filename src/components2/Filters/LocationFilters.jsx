...
import { LocationTabFilters, OfficerFilter, terminalFilter } from "../../constants/DummyConstants";
            ...
            <div className="filter-content">
                {LocationTabFilters?.map((item, i) => {
                    if (item.type === "multi") {
                        ...
                        else if (item?.name === "bq_location_address_county_name"
                            || item?.name === "bq_location_type" ||
                            item?.name === "bq_location_address_state_name" ||
                            item?.name === "bq_location_address_cbsa_name"
                        ) {
                        ...
                        return (
                            <div className="single-select1" key={i + "kiw"} >
                                ...
                                <select
                                    ...
                                    disabled={item?.type === "disable" ? true : false}
                                >
